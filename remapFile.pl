...
remapFile.pl - takes a file with tab deliminated mappings and substitutes each of the first terms for each of the second terms

=head1 SYNOPSIS

remapFile.pl [options] [file ...]
...
B<remapFile.pl> takes a file with tab deliminated mappings and substitutes each of the first terms for each of the second terms
