...
# Last Modified: 2012 Dec 24 03:03:01 PM
...
my $force;
my $delete;
GetOptions('delete' => \$delete, 'force' => \$force, 'help|?' => \$help, man => \$man) or pod2usage(2);
pod2usage(2) if $help;
...
die "$new_filename exists, use --force to overwrite" if -e $new_filename and not $force;
