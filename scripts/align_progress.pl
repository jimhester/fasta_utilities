...
align_progress.pl [options] input output
...
B<align_progress.pl> given the input filename and the output filename, figures out the last line using tail, then greps for that header in the input, and works out the percentage that way
