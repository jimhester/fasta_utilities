...
fastxInList.pl - reads a list of headers, and a fastx file and outputs records which are in the list

=head1 SYNOPSIS

fastxInList.pl [options] [file ...]
...
B<fastxInList.pl> reads a list of headers, and a fastx file and outputs records which are in the list
