...
# Date:01/05/2012
# Title:remapFasta.pl
# Purpose:remapps fasta sequences from the first file to fasta sequences from the second file, matches by hashing the sequence
###############################################################################
...
remapFasta.pl - remapps fasta sequences from the first file to fasta sequences from the second file, matches by hashing the sequence

=head1 SYNOPSIS

remapFasta.pl [options] [file ...]
...
B<remapFasta.pl> remapps fasta sequences from the first file to fasta sequences from the second file, matches by hashing the sequence
